    ...
    for  fN=1:7
        ...
        for tk=1:N                                                %notice the tk can not be used again below
           ...
           delta_n3m=tau^2*1/2*B.^2.*(  -conj(ps(1))*fft(F_2m) + -conj(ps(2))*fft(F_2p)+ -conj(ps(3))*fft(F_1m) + -conj(ps(4))*fft(F_1p)  )+...
            ...
            -( conj(rs(1,1))*H_1mmm + conj(rs(1,2))*H_1mmp+  conj(rs(1,3))*H_1mpm+ conj(rs(1,4))*H_1mpp+ conj(rs(2,1))*H_2mmm + conj(rs(2,2))*H_2mmp+  conj(rs(2,3))*H_2mpm+ conj(rs(2,4))*H_2mpp...
                +conj(rs(3,1))*H_3mmm +conj(rs(3,2))*H_3mmp+  conj(rs(3,3))*H_3mpm+ conj(rs(3,4))*H_3mpp+ conj(rs(4,1))*H_4mmm +conj(rs(4,2))*H_4mmp+ conj( rs(4,3))*H_4mpm+ conj(rs(4,4))*H_4mpp...
                +conj(rs(5,1))*H_1pmm+conj(rs(5,2))*H_1pmp+ conj(rs(5,3))*H_1ppm+ conj(rs(5,4))*H_1ppp+ conj(rs(6,1))*H_2pmm +conj(rs(6,2))*H_2pmp+  conj(rs(6,3))*H_2ppm+ conj(rs(6,4))*H_2ppp...
                +conj(rs(7,1))*H_3pmm+conj(rs(7,2))*H_3pmp+ conj(rs(7,3))*H_3ppm+ conj(rs(7,4))*H_3ppp+ conj(rs(8,1))*H_4pmm +conj(rs(8,2))*H_4pmp+  conj(rs(8,3))*H_4ppm+ conj(rs(8,4))*H_4ppp  )...
